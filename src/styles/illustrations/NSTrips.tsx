...
export const NSTrips: FC<Props> = ({ className }) => {
  return (
    <svg viewBox="0 0 65 55" className={className} xmlns="http://www.w3.org/2000/svg">
      <g>
      ...
      <g>
        ...
        <polygon
          id="svg_4"
          fill="#d9e2ec"
          points="29.148 27.905 36.672 48.579 42.31 46.527 40.424 23.801 29.148 27.905"
        />
